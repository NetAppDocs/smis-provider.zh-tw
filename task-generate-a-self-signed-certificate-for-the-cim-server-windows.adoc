...
CAUTION: 安裝 SMI-S 提供者時，預設安裝的自簽名憑證已過時。因此，在 System Center Virtual Machine Manager (SCVMM) 的「新增儲存設備」中，與 SMI-S 提供者的 SSL 連線失敗。您需要為 CIM 伺服器產生自簽章證書，然後重新啟動 SMI-S 提供者服務。更多信息，請參閱 link:https://kb.netapp.com/data-mgmt/SMI-S/SMI-S_Issues/CSMIS-3["NetApp知識庫文章：“CSMIS-3： NetApp SMI-S Provider 5.2.7 中的 cimom.cert 在安裝時已過期。”"^]
